...
public static class SetsAndMaps
{
    ...
    public static string[] FindPairs(string[] words)
    {
        ...
        {
            // Words with two identical letters (e.g. 'aa') can never form a pair
            if (word[0] == word[1])
                continue;
    ...
    public static bool IsAnagram(string word1, string word2)
    {
        ...
        // Count each letter in word1 (ignoring spaces and case)
        ...
        // Subtract each letter in word2; fail if a letter is missing or used up
        ...
        // Any leftover counts mean word1 had extra letters
    ...
    public static string[] EarthquakeDailySummary()
    {
        ...
        return featureCollection.Features
            .Where(feature => feature.Properties.Place != null && feature.Properties.Mag != null)
